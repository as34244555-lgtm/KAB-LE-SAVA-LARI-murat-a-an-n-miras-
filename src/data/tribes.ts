...
export const UNITS: UnitDefinition[] = [
  ...
  },
  {
    ...
    name: "Deve Süvarisi",
    unitClass: "bomber",
    lore: "Çölü aşan deve sürüleri barutu ve suyu aynı semere bağlar.",
    baseCost: 62,
    baseHp: 95,
    baseAttack: 24,
    baseDefense: 12,
  ...
  },
  {
    ...
    name: "Panter İzcisi",
    unitClass: "skirmisher",
    lore: "Sisli patikalarda panterle yürüyenler, hançerin gölgesini ilk duyanlardır.",
    baseCost: 68,
    baseHp: 48,
    baseAttack: 26,
    baseDefense: 5,
  ...
  },
  {
    ...
    name: "Burç Muhafızı",
    unitClass: "guardian",
    lore: "Buz burçlarında nöbet tutanlar, yemini kalkanın arkasına yazar.",
    baseCost: 72,
    baseHp: 140,
    baseAttack: 14,
    baseDefense: 30,
